...
SET @query = '
Alter Table {DB1Name}.dre.DRE_CASE_AO_INTERVIEWS
NOCHECK CONSTRAINT [FK_DRE_CASE_AO_INTERVIEWS_DRE_CASES_DreCaseId]
...
Alter Table {DB1Name}.dre.DRE_CASE_AO_INTERVIEWS
CHECK CONSTRAINT [FK_DRE_CASE_AO_INTERVIEWS_DRE_CASES_DreCaseId]';
