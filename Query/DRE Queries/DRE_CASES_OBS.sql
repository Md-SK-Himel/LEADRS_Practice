--Conversion failed when converting the varchar value 'shot with a bb gun' to data type bit.
--field: BlindnessComment in LEADRS_CORE_DEV_DUI.dre.DRE_CASES_OBS
...
SET @query = '
Alter Table {DB1Name}.dre.DRE_CASES_OBS
NOCHECK CONSTRAINT FK_DRE_CASES_OBS_DRE_CASES_DreCaseId
...
Alter Table {DB1Name}.dre.DRE_CASES_OBS
CHECK CONSTRAINT FK_DRE_CASES_OBS_DRE_CASES_DreCaseId';
