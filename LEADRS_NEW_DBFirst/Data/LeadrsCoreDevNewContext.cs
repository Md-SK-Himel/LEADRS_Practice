...
public partial class LeadrsCoreDevNewContext : DbContext
{
    ...
    public virtual DbSet<DreCaseArrestingOfficerFST> DreCaseAoFsts { get; set; }

    public virtual DbSet<DreCaseArrestingOfficerInterview> DreCaseAoInterviews { get; set; }
    ...
    public virtual DbSet<DreCaseOneLegStand> DreCaseOls { get; set; }
    ...
    public virtual DbSet<DreCasePicture> DreCasePics { get; set; }

    public virtual DbSet<DreCaseRombergBalance> DreCaseRbs { get; set; }
    ...
    public virtual DbSet<DreCaseWalkTurn> DreCaseWts { get; set; }

    public virtual DbSet<DreCaseArrestingOfficerObservation> DreCasesAoObs { get; set; }

    public virtual DbSet<DreCaseDarkRoom> DreCasesDarkRooms { get; set; }

    public virtual DbSet<DreCaseFingerToNose> DreCasesFtns { get; set; }

    public virtual DbSet<DreCaseObservations> DreCasesObs { get; set; }

    public virtual DbSet<DreCaseOffense> DreCasesOffenses { get; set; }

    public virtual DbSet<DreCaseOtherOfficer> DreCasesOtherOfficers { get; set; }

    public virtual DbSet<DreCaseVitalSign> DreCasesVitalSigns { get; set; }

    public virtual DbSet<DreCaseDefendant> DreDefendants { get; set; }
    ...
    public virtual DbSet<ArrestingOfficerType> TblOptAoTypes { get; set; }
    ...
    public virtual DbSet<DpsDrugList> TblOptDpsDrugLists { get; set; }

    public virtual DbSet<DRECaseStatus> TblOptDreCaseStatuses { get; set; }

    public virtual DbSet<DreCaseFirstIndicator> TblOptDreFirstIndicators { get; set; }

    public virtual DbSet<TblOptDreFirstIndicator1> TblOptDreFirstIndicators1 { get; set; }

    public virtual DbSet<DreMajorIndicator> TblOptDreMajorIndicators { get; set; }
    ...
    public virtual DbSet<DreNotified> TblOptDreNotifieds { get; set; }

    public virtual DbSet<TblOptDreNotified1> TblOptDreNotifieds1 { get; set; }

    public virtual DbSet<ReactionToLight> TblOptDreReactionToLights { get; set; }

    public virtual DbSet<TblOptDreReactionToLight1> TblOptDreReactionToLights1 { get; set; }

    public virtual DbSet<DreRequested> TblOptDreRequesteds { get; set; }

    public virtual DbSet<TblOptDreRequested1> TblOptDreRequesteds1 { get; set; }

    public virtual DbSet<DRERole> TblOptDreRoles { get; set; }

    public virtual DbSet<TblOptDreRole1> TblOptDreRoles1 { get; set; }

    public virtual DbSet<DreCaseSecondIndicator> TblOptDreSecondIndicators { get; set; }

    public virtual DbSet<DREType> TblOptDreTypes { get; set; }
    ...
    public virtual DbSet<DreCaseToxSpecType> TblOptToxSpecTypes { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog=LEADRS_CORE_DEV_NEW;Integrated Security=True");
    ...
    //    modelBuilder.Entity<DreCaseArrestingOfficerFST>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.ArrestingOfficerFST).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseArrestingOfficerInterview>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.ArrestingOfficerInterview).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseHGN>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithMany(p => p.Hgns).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseImage>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithMany(p => p.Images).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseIndicator>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.Indicator).OnDelete(DeleteBehavior.ClientSetNull);
    //    });
    ...
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.IntoxilyzerReport).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseNote>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithMany(p => p.Notes).OnDelete(DeleteBehavior.ClientSetNull);
    ...
    //    modelBuilder.Entity<DreCaseOneLegStand>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.OneLegStand).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseOtherObservation>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.OtherObservation).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCasePicture>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithMany(p => p.Pictures).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseRombergBalance>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.RombergBalance).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseVideo>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithMany(p => p.Videos).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseWalkTurn>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.WalkTurn).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseArrestingOfficerObservation>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.ArrestingOfficerObservation).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseDarkRoom>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.DarkRoom).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseFingerToNose>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.FingerToNose).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseObservations>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.Observations).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseOffense>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.Offense).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseOtherOfficer>(entity =>
    //    {
    //        entity.Property(e => e.IsOwner).HasDefaultValueSql("(CONVERT([bit],(0)))");

    //        entity.HasOne(d => d.DreCase).WithMany(p => p.OtherOfficers).OnDelete(DeleteBehavior.ClientSetNull);

    //        entity.HasOne(d => d.DRERole).WithMany(p => p.DreCasesOtherOfficers).OnDelete(DeleteBehavior.SetNull);
    //    });

    //    modelBuilder.Entity<DreCaseVitalSign>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.VitalSign).OnDelete(DeleteBehavior.ClientSetNull);
    //    });

    //    modelBuilder.Entity<DreCaseDefendant>(entity =>
    //    {
    //        entity.HasOne(d => d.DreCase).WithOne(p => p.Defendant).OnDelete(DeleteBehavior.ClientSetNull);
    //    });
    ...
    //    modelBuilder.Entity<DRERole>(entity =>
    //    {
